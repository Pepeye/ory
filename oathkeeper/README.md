# Rust API client for oathkeeper
...
Put the package under your project folder in a directory named `oathkeeper` and add the following to `Cargo.toml` under `[dependencies]`:

```
oathkeeper = { path = "./oathkeeper" }
```
